...
@section('title', 'Tambah Pendidikan - Dash')
    ...
    <div class="d-flex justify-content-center">
        <form action="{{ route('applicant.storeEducation') }}" method="POST">
            ...
            <div class="card p-4" style="width: 600px;">
                <h3 class="section-title mb-4 text-center">Tambah Pendidikan</h3>
                <div class="form-group">
                    <label for="degree">Jenjang</label>
                    <input type="text" name="degree" class="form-control mb-3" id="degree" required>
                </div>
                <div class="form-group">
                    <label for="institution">Institusi</label>
                    <input type="text" name="institution" class="form-control mb-3" id="institution" required>
                </div>
                <div class="form-group">
