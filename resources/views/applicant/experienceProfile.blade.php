...
@section('title', 'Tambah Pengalaman Kerja - Dash')
...
<div class="container mt-5" style="overflow: hidden;">
    <div class="d-flex justify-content-center">
        <form action="{{ route('applicant.storeExperience') }}" method="POST">
            @csrf
            <div class="card p-4" style="width: 600px;">
                <h3 class="section-title mb-4 text-center">Tambah Pengalaman</h3>
                <div class="form-group">
                    <label for="job_title">Peran</label>
                    <input type="text" name="job_title" class="form-control mb-3" id="job_title" required>
                </div>
                <div class="form-group">
                    <label for="company">Perusahaan</label>
                    <input type="text" name="company" class="form-control mb-3" id="company" required>
                </div>
                <div class="form-group">
